...
def save_scan(repo: str, cache_key: str, result: dict) -> int:
    """Persist a freshly computed report (upsert on cache_key); return its scan id."""
