...
from src.scanner.modules.memory_extraction import MemoryExtractionConfig, run as run_memory_extraction
...
def _check_size(info):
    ...
    def _run_scan(repo, params, weight_bytes, gen, modules, generation_settings, sample=None):
        ...
        try:
            ...
            if 'model' in locals() and hasattr(model, "vllm_engine") and model.vllm_engine is not None:
                try:
